...
var chart_list = [
    ...
    ,{ id: 999, level: 3, rate_base: 00.0, name: "チルドレンレコード" }
    ,{ id: 999, level: 3, rate_base: 00.0, name: "如月アテンション" }
    ,{ id: 999, level: 3, rate_base: 00.0, name: "夜咄ディセイブ" }
    ,{ id: 999, level: 3, rate_base: 00.0, name: "DRAGONLADY" }
];
